...
public class CraftSniffer extends CraftAnimals implements Sniffer {
    ...
    public void removeExploredLocation(Location location) {
        ...
        // Paper start
        net.minecraft.world.level.Level level = location.getWorld() != null ? ((org.bukkit.craftbukkit.v1_20_R3.CraftWorld) location.getWorld()).getHandle() : this.getHandle().level();
