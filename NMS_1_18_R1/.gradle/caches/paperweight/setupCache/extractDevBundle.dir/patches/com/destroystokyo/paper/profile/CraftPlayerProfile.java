...
import org.bukkit.craftbukkit.v1_18_R1.profile.CraftPlayerTextures;
import org.bukkit.craftbukkit.v1_18_R1.profile.CraftProfileProperty;
...
public class CraftPlayerProfile implements PlayerProfile, SharedPlayerProfile {
    ...
    public String toString() {
        return "CraftPlayerProfile [uniqueId=" + getId() +
            ", name=" + getName() +
            ", properties=" + org.bukkit.craftbukkit.v1_18_R1.profile.CraftPlayerProfile.toString(this.profile.getProperties()) +
            "]";
    }
