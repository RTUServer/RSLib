...
public final class CraftScoreboard implements org.bukkit.scoreboard.Scoreboard {
    ...
    public ImmutableSet<Score> getScoresFor(org.bukkit.entity.Entity entity) throws IllegalArgumentException {
        ...
        return this.getScores(((org.bukkit.craftbukkit.v1_18_R1.entity.CraftEntity) entity).getHandle().getScoreboardName());
    }

    @Override
    public void resetScoresFor(org.bukkit.entity.Entity entity) throws IllegalArgumentException {
        Validate.notNull(entity, "Entity cannot be null");
        this.resetScores(((org.bukkit.craftbukkit.v1_18_R1.entity.CraftEntity) entity).getHandle().getScoreboardName());
    }

    @Override
    public Team getEntityTeam(org.bukkit.entity.Entity entity) throws IllegalArgumentException {
        Validate.notNull(entity, "Entity cannot be null");
        return this.getEntryTeam(((org.bukkit.craftbukkit.v1_18_R1.entity.CraftEntity) entity).getHandle().getScoreboardName());
    }
    // Paper end
}
