...
public class CraftPotionEffectType extends PotionEffectType {
    ...
    public org.bukkit.NamespacedKey getKey() {
        return org.bukkit.craftbukkit.v1_18_R1.util.CraftNamespacedKey.fromMinecraft(net.minecraft.core.Registry.MOB_EFFECT.getKey(this.handle));
    }
    ...
    public java.util.Map<org.bukkit.attribute.Attribute, org.bukkit.attribute.AttributeModifier> getEffectAttributes() {
        ...
        this.handle.getAttributeModifiers().forEach((attribute, attributeModifier) -> {
            attributeMap.put(org.bukkit.craftbukkit.v1_18_R1.attribute.CraftAttributeMap.fromMinecraft(attribute.toString()), org.bukkit.craftbukkit.v1_18_R1.attribute.CraftAttributeInstance.convert(attributeModifier));
        });
    ...
    public double getAttributeModifierAmount(org.bukkit.attribute.Attribute attribute, int effectAmplifier) {
        ...
        net.minecraft.world.entity.ai.attributes.Attribute nmsAttribute = org.bukkit.craftbukkit.v1_18_R1.attribute.CraftAttributeMap.toMinecraft(attribute);
