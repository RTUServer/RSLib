...
public final class CraftItemFactory implements ItemFactory {
    ...
    public ItemStack enchantWithLevels(ItemStack itemStack, int levels, boolean allowTreasure, java.util.Random random) {
        ...
        final net.minecraft.world.item.ItemStack enchanted = net.minecraft.world.item.enchantment.EnchantmentHelper.enchantItem(new org.bukkit.craftbukkit.v1_19_R2.util.RandomSourceWrapper(random), internalStack, levels, allowTreasure);
