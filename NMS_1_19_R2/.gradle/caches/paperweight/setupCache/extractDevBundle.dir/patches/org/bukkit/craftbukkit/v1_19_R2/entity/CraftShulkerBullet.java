...
public class CraftShulkerBullet extends AbstractProjectile implements ShulkerBullet {
    ...
    public org.bukkit.block.BlockFace getCurrentMovementDirection() {
        return org.bukkit.craftbukkit.v1_19_R2.block.CraftBlock.notchToBlockFace(this.getHandle().currentMoveDirection);
    }

    @Override
    public void setCurrentMovementDirection(org.bukkit.block.BlockFace movementDirection) {
        this.getHandle().currentMoveDirection = org.bukkit.craftbukkit.v1_19_R2.block.CraftBlock.blockFaceToNotch(movementDirection);
    }
