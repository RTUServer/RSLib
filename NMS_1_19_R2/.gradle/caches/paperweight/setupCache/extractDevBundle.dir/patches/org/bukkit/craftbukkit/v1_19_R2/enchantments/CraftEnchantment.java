...
public class CraftEnchantment extends Enchantment {
    ...
    public float getDamageIncrease(int level, org.bukkit.entity.EntityCategory entityCategory) {
        return target.getDamageBonus(level, org.bukkit.craftbukkit.v1_19_R2.entity.CraftLivingEntity.fromBukkitEntityCategory(entityCategory));
    }

    @Override
    public java.util.Set<org.bukkit.inventory.EquipmentSlot> getActiveSlots() {
        return java.util.stream.Stream.of(target.slots).map(org.bukkit.craftbukkit.v1_19_R2.CraftEquipmentSlot::getSlot).collect(java.util.stream.Collectors.toSet());
    }
