...
import org.bukkit.craftbukkit.v1_19_R2.profile.CraftPlayerTextures;
import org.bukkit.craftbukkit.v1_19_R2.profile.CraftProfileProperty;
...
public class CraftPlayerProfile implements PlayerProfile, SharedPlayerProfile {
    ...
    public String toString() {
        return "CraftPlayerProfile [uniqueId=" + getId() +
            ", name=" + getName() +
            ", properties=" + org.bukkit.craftbukkit.v1_19_R2.profile.CraftPlayerProfile.toString(this.profile.getProperties()) +
            "]";
    }
