...
public class CraftArrow extends AbstractProjectile implements AbstractArrow {
    ...
    // Paper start
    @Override
    public org.bukkit.craftbukkit.v1_19_R3.inventory.CraftItemStack getItemStack() {
        return org.bukkit.craftbukkit.v1_19_R3.inventory.CraftItemStack.asCraftMirror(getHandle().getPickupItem());
    }
    ...
    public org.bukkit.Sound getHitSound() {
        return org.bukkit.craftbukkit.v1_19_R3.CraftSound.getBukkit(this.getHandle().soundEvent);
    }

    @Override
    public void setHitSound(@org.jetbrains.annotations.NotNull org.bukkit.Sound sound) {
        this.getHandle().setSoundEvent(org.bukkit.craftbukkit.v1_19_R3.CraftSound.getSoundEffect(sound));
    }
