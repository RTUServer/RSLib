...
public final class CraftMagicNumbers implements UnsafeValues {
    ...
    public byte[] serializeEntity(org.bukkit.entity.Entity entity) {
        ...
        Preconditions.checkArgument(entity instanceof org.bukkit.craftbukkit.v1_19_R3.entity.CraftEntity, "only CraftEntities can be serialized");

        CompoundTag compound = new CompoundTag();
        ((org.bukkit.craftbukkit.v1_19_R3.entity.CraftEntity) entity).getHandle().serializeEntity(compound);
    ...
    public org.bukkit.entity.Entity deserializeEntity(byte[] data, org.bukkit.World world, boolean preserveUUID) {
        ...
        return net.minecraft.world.entity.EntityType.create(compound, ((org.bukkit.craftbukkit.v1_19_R3.CraftWorld) world).getHandle())
    ...
    public org.bukkit.NamespacedKey getBiomeKey(org.bukkit.RegionAccessor accessor, int x, int y, int z) {
        org.bukkit.craftbukkit.v1_19_R3.CraftRegionAccessor cra = (org.bukkit.craftbukkit.v1_19_R3.CraftRegionAccessor) accessor;
        return org.bukkit.craftbukkit.v1_19_R3.util.CraftNamespacedKey.fromMinecraft(cra.getHandle().registryAccess().registryOrThrow(net.minecraft.core.registries.Registries.BIOME).getKey(cra.getHandle().getBiome(new net.minecraft.core.BlockPos(x, y, z)).value()));
    }

    @Override
    public void setBiomeKey(org.bukkit.RegionAccessor accessor, int x, int y, int z, org.bukkit.NamespacedKey biomeKey) {
        org.bukkit.craftbukkit.v1_19_R3.CraftRegionAccessor cra = (org.bukkit.craftbukkit.v1_19_R3.CraftRegionAccessor) accessor;
        net.minecraft.core.Holder<net.minecraft.world.level.biome.Biome> biomeBase = cra.getHandle().registryAccess().registryOrThrow(net.minecraft.core.registries.Registries.BIOME).getHolderOrThrow(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.BIOME, org.bukkit.craftbukkit.v1_19_R3.util.CraftNamespacedKey.toMinecraft(biomeKey)));
