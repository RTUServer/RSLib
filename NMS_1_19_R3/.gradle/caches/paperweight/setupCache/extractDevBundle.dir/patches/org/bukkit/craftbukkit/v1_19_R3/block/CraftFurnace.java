...
public abstract class CraftFurnace<T extends AbstractFurnaceBlockEntity> extends CraftContainer<T> implements Furnace {
    ...
    public int getRecipeUsedCount(org.bukkit.NamespacedKey furnaceRecipe) {
        return this.getSnapshot().getRecipesUsed().getInt(org.bukkit.craftbukkit.v1_19_R3.util.CraftNamespacedKey.toMinecraft(furnaceRecipe));
    }

    @Override
    public boolean hasRecipeUsedCount(org.bukkit.NamespacedKey furnaceRecipe) {
        return this.getSnapshot().getRecipesUsed().containsKey(org.bukkit.craftbukkit.v1_19_R3.util.CraftNamespacedKey.toMinecraft(furnaceRecipe));
    }

    @Override
    public void setRecipeUsedCount(org.bukkit.inventory.CookingRecipe<?> furnaceRecipe, int count) {
        final net.minecraft.resources.ResourceLocation location = org.bukkit.craftbukkit.v1_19_R3.util.CraftNamespacedKey.toMinecraft(furnaceRecipe.getKey());
