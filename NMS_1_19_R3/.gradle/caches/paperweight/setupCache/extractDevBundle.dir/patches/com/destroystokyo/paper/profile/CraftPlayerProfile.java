...
import org.bukkit.craftbukkit.v1_19_R3.profile.CraftPlayerTextures;
import org.bukkit.craftbukkit.v1_19_R3.profile.CraftProfileProperty;
...
public class CraftPlayerProfile implements PlayerProfile, SharedPlayerProfile {
    ...
    public String toString() {
        return "CraftPlayerProfile [uniqueId=" + getId() +
            ", name=" + getName() +
            ", properties=" + org.bukkit.craftbukkit.v1_19_R3.profile.CraftPlayerProfile.toString(this.profile.getProperties()) +
            "]";
    }
