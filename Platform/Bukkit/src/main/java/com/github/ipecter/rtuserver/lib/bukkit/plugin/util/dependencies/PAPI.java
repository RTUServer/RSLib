package com.github.ipecter.rtuserver.lib.bukkit.plugin.util.dependencies;
...
public class PAPI {
    ...
    public static @NotNull TagResolver tag(final @NotNull Player player) {
        return TagResolver.resolver("papi", (argumentQueue, context) -> {
            ...
            if (!RSLib.getInstance().isEnabledDependency("PlaceholderAPI")) return Tag.selfClosingInserting(Component.empty());
