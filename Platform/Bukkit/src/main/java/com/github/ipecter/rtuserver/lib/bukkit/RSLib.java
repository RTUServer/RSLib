...
public class RSLib extends RSPlugin implements ChannelInitializeListener, ProtoLogger.IProtoLogger {
    ...
    public void enable() {
        ...
        ProtoWeaver.PROTOCOL_LOADED.register(protocol -> registerProto())
    }
