...
public final class CraftMagicNumbers implements UnsafeValues {
    ...
    public byte[] serializeEntity(org.bukkit.entity.Entity entity) {
        ...
        Preconditions.checkArgument(entity instanceof org.bukkit.craftbukkit.v1_17_R1.entity.CraftEntity, "only CraftEntities can be serialized");

        CompoundTag compound = new CompoundTag();
        ((org.bukkit.craftbukkit.v1_17_R1.entity.CraftEntity) entity).getHandle().serializeEntity(compound);
    ...
    public org.bukkit.entity.Entity deserializeEntity(byte[] data, org.bukkit.World world, boolean preserveUUID) {
        ...
        return net.minecraft.world.entity.EntityType.create(compound, ((org.bukkit.craftbukkit.v1_17_R1.CraftWorld) world).getHandle())
    ...
    public com.google.common.collect.Multimap<org.bukkit.attribute.Attribute, org.bukkit.attribute.AttributeModifier> getItemAttributes(org.bukkit.Material material, org.bukkit.inventory.EquipmentSlot equipmentSlot) {
        ...
        item.getDefaultAttributeModifiers(org.bukkit.craftbukkit.v1_17_R1.CraftEquipmentSlot.getNMS(equipmentSlot)).forEach((attributeBase, attributeModifier) -> {
            attributeMapBuilder.put(org.bukkit.Registry.ATTRIBUTE.get(CraftNamespacedKey.fromMinecraft(net.minecraft.core.Registry.ATTRIBUTE.getKey(attributeBase))), org.bukkit.craftbukkit.v1_17_R1.attribute.CraftAttributeInstance.convert(attributeModifier, equipmentSlot));
        });
