...
public abstract class CraftRegionAccessor implements RegionAccessor {
    ...
    public void setBiome(int x, int y, int z, Biome biome) {
        ...
        net.minecraft.world.level.biome.Biome biomeBase = CraftBlock.biomeToBiomeBase(this.getHandle().registryAccess().registryOrThrow(Registry.BIOME_REGISTRY), biome);
    ...
    public void setBlockData(int x, int y, int z, BlockData blockData) {
        CraftBlock.at(this.getHandle(), new BlockPos(x, y, z)).setTypeAndData(((CraftBlockData) blockData).getState(), true);
    }
    ...
    public boolean generateTree(Location location, Random random, TreeType treeType) {
        ...
        return this.generateTree(this.getHandle(), this.getHandle().getMinecraftWorld().getChunkSource().generator, pos, random, treeType);
    }
    ...
    public boolean generateTree(Location location, Random random, TreeType treeType, Consumer<BlockState> consumer) {
        ...
        boolean result = this.generateTree(populator, this.getHandle().getMinecraftWorld().getChunkSource().generator, pos, random, treeType);
        ...
        if (Boat.class.isAssignableFrom(clazz)) {
            ...
            if (Snowball.class.isAssignableFrom(clazz)) {
                ...
                if (TippedArrow.class.isAssignableFrom(clazz)) {
                    ...
                    ((Arrow) entity).setType(CraftPotionUtil.fromBukkit(new PotionData(PotionType.WATER, false, false)));
