...
public final class VanillaCommandWrapper extends BukkitCommand {
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        ...
        this.dispatcher.performCommand(icommandlistener, this.toDispatcher(args, getName()), this.toDispatcher(args, commandLabel), true);
        return true;
    }
    ...
    public static CommandSourceStack getListener(CommandSender sender) {
        ...
        if (sender instanceof org.bukkit.craftbukkit.v1_17_R1.entity.CraftEntity craftEntity) {
