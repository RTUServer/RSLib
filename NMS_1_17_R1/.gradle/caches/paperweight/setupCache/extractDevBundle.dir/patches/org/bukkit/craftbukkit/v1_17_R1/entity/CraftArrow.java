...
public class CraftArrow extends AbstractProjectile implements AbstractArrow {
    ...
    // Paper start
    @Override
    public org.bukkit.craftbukkit.v1_17_R1.inventory.CraftItemStack getItemStack() {
        return org.bukkit.craftbukkit.v1_17_R1.inventory.CraftItemStack.asCraftMirror(getHandle().getPickupItem());
    }
    // Paper end
