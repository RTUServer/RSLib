...
import org.bukkit.craftbukkit.v1_17_R1.entity.memory.CraftMemoryKey;
import org.bukkit.craftbukkit.v1_17_R1.entity.memory.CraftMemoryMapper;
...
public class CraftLivingEntity extends CraftEntity implements LivingEntity {
    ...
    public Block getTargetBlock(int maxDistance, com.destroystokyo.paper.block.TargetBlockInfo.FluidMode fluidMode) {
        ...
        return !(rayTrace instanceof net.minecraft.world.phys.BlockHitResult) ? null : org.bukkit.craftbukkit.v1_17_R1.block.CraftBlock.at(getHandle().level, ((net.minecraft.world.phys.BlockHitResult)rayTrace).getBlockPos());
    }
    ...
    public com.destroystokyo.paper.block.TargetBlockInfo getTargetBlockInfo(int maxDistance, com.destroystokyo.paper.block.TargetBlockInfo.FluidMode fluidMode) {
        ...
        return !(rayTrace instanceof net.minecraft.world.phys.BlockHitResult) ? null :
            new com.destroystokyo.paper.block.TargetBlockInfo(org.bukkit.craftbukkit.v1_17_R1.block.CraftBlock.at(getHandle().level, ((net.minecraft.world.phys.BlockHitResult)rayTrace).getBlockPos()),
    ...
    public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity) {
        ...
        if (Snowball.class.isAssignableFrom(projectile)) {
            ...
            if (TippedArrow.class.isAssignableFrom(projectile)) {
                ...
                ((Arrow) launch).setType(CraftPotionUtil.fromBukkit(new PotionData(PotionType.WATER, false, false)));
