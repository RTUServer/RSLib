...
public final class OldCraftChunkData implements ChunkGenerator.ChunkData {
    ...
    private LevelChunkSection getChunkSection(int y, boolean create) {
        ...
        if (create && section == null) {
            this.sections[offset] = section = new LevelChunkSection(offset + (this.minHeight >> 4), null, world instanceof org.bukkit.craftbukkit.v1_17_R1.CraftWorld ? ((org.bukkit.craftbukkit.v1_17_R1.CraftWorld) this.world).getHandle() : null, true); // Paper - Anti-Xray - Add parameters
        }
        return section;
    }
