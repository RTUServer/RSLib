...
public class CraftChunk implements Chunk {
    ...
    public boolean isEntitiesLoaded() {
        return this.getCraftWorld().getHandle().entityManager.areEntitiesLoaded(ChunkPos.asLong(x, z)); // PAIL rename isEntitiesLoaded
    }
    ...
    public static ChunkSnapshot getEmptyChunkSnapshot(int x, int z, CraftWorld world, boolean includeBiome, boolean includeBiomeTempRain) {
        ...
        if (includeBiome || includeBiomeTempRain) {
            ...
            biome = new ChunkBiomeContainer(world.getHandle().registryAccess().registryOrThrow(Registry.BIOME_REGISTRY), world.getHandle(), new ChunkPos(x, z), wcm);
        }
